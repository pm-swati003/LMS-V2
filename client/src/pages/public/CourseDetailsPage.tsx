...
export default function CourseDetailsPage() {
  ...
  return (
    <div className="animate-in fade-in duration-500 min-h-screen pb-20 bg-background text-foreground">
...
<section className="relative overflow-hidden bg-foreground text-background">
  ...
  <div className="container mx-auto px-4 md:px-8 relative z-10 py-16 md:py-24">
    <div className="max-w-3xl">
      ...
      <div className="space-y-2 mb-8 text-background/80">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <Tabs defaultValue="overview" className="w-full">
              <TabsList className="w-full justify-start border-b border-border bg-transparent p-0 mb-8 h-auto rounded-none overflow-x-auto">
  {["Overview", "Discussion", "Review", "Instructor"].map((tab) => (
    <TabsTrigger
      key={tab}
  ...
  <CheckCircle2 className="size-4 text-emerald-600 shrink-0" />
          ...
          <span className="text-muted-foreground leading-relaxed text-sm font-medium">
            {item}
          </span>
        </div>
      ))}
  ...
  <div className="max-w-none text-muted-foreground leading-relaxed text-sm">
  ...
  <div className="border border-border rounded-lg p-8 bg-card shadow-sm flex flex-col md:flex-row items-center gap-8 md:gap-12">
    ...
    <div className="flex-1 w-full space-y-3">
      {[5, 4, 3, 2, 1].map((rating) => (
        <div key={rating} className="flex items-center gap-4">
          <span className="font-medium text-muted-foreground w-3 text-sm">
            {rating}
          </span>

          <div className="flex gap-1 text-primary">
            {[1, 2, 3, 4, 5].map((s) => (
              <Star key={s} className="size-4 text-muted-foreground" />
            ))}
          </div>
  ...
  <Card className="sticky top-24 border-border shadow-sm">
    <CardContent className="p-0">
      ...
      <div className="relative aspect-video bg-muted flex items-center justify-center border-b border-border">
        <div className="size-16 rounded-full bg-background/80 flex items-center justify-center cursor-pointer hover:scale-110 transition-transform shadow-sm">
          <div className="size-12 rounded-full bg-primary flex items-center justify-center">
            <PlayCircle className="size-6 text-primary-foreground fill-current" />
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <div className="flex justify-between">
            <div className="flex items-center gap-2">
              <BarChart className="size-4" /> Course Level
            </div>
            <span className="font-medium text-foreground">
              {course.level}
            </span>
          ...
          <div className="flex justify-between">
            <div className="flex items-center gap-2">
              <Users className="size-4" /> Student Enrolled
            </div>
            <span className="font-medium text-foreground">
              {course.students}
            </span>
        ...
        <Button className="w-full h-11 text-base">
          Enroll the Course
          <Link href="/auth/signup" className="absolute inset-0" />
          <Share2 className="ml-2 size-4 rotate-180" />
        </Button>
