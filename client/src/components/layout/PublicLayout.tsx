  ...
  const navLinks: NavItem[] = [
    { name: "Home", href: "/" },
    {
      ...
      children: [
        ...
        {
          name: "Skill Enhancement Programs",
          href: "/programs/skill-enhancement",
        },
      ],
    },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { name: "Minors", href: "/exams/minors" },
            {
              ...
              href: "/exams/skill-enhancement",
            },
            {
              name: "Skill Enhancement Programs (12 Credit)",
              href: "/exams/skill-enhancement-12",
            },
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: "Apply for Skill Enhancement",
          href: "/academics/skill-enhancement",
        },
    ...
    <span className="hidden md:block text-[11px] text-muted-foreground">
      State Technological University, Govt. of Karnataka
                      ...
                      {link.children.map((child) => (
                        <DropdownMenuItem key={child.name} asChild>
                          <Link href={child.href}>
                            <a
                              className={`w-full cursor-pointer ${location === child.href ? "text-primary" : ""}`}
                            >
                              {child.name}
                            </a>
                          </Link>
                        ...
                        <div key={group.label}>
                          ...
                          {group.items.map((item) => (
                            <DropdownMenuItem key={item.name} asChild>
                              <Link href={item.href}>
                                <a
                                  className={`w-full cursor-pointer ${location === item.href ? "text-primary" : ""}`}
                                >
                                  {item.name}
                                </a>
                              </Link>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
              side="right"
              className="w-full sm:w-80 p-0 flex flex-col [&>button]:hidden"
            >
